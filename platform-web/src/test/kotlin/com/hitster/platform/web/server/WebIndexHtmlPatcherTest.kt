...
class WebIndexHtmlPatcherTest {
    ...
    fun patchInjectsMobileViewportTouchHandlingCanvasSizingWakeLockAndFullscreenSupport() {
        ...
        assertContains(patchedHtml, "wakeWebmSource.src = \"data:video/webm;base64,")
        ...
        assertContains(patchedHtml, "wakeFallbackVideo.style.opacity = \"0.001\";")
        ...
        assertContains(patchedHtml, "var wakeFallbackEnabled = false;")
        assertContains(patchedHtml, "if (wakeFallbackEnabled && !wakeVideo.paused) {")
