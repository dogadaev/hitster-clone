...
class WebIndexHtmlPatcherTest {
    ...
    fun patchInjectsMobileViewportTouchHandlingCanvasSizingAndWakeLockSupport() {
        ...
        assertContains(patchedHtml, "return !!(noSleep && noSleep.isEnabled);")
        assertContains(patchedHtml, "noSleep.enable()).then(function(result) {")
        assertContains(patchedHtml, "if (noSleep && noSleep.isEnabled) {")
        assertContains(patchedHtml, "noSleep.disable();")
        assertContains(patchedHtml, "var wakeActivationReceived = false;")
        assertContains(patchedHtml, "var wakeEnableRequested = false;")
        ...
        assertContains(patchedHtml, "if (document.hidden || wakeEnableRequested) {")
        assertContains(patchedHtml, "wakeActivationReceived = true;")
        assertContains(patchedHtml, "wakeEnableRequested = true;")
        ...
        assertContains(patchedHtml, "wakeEnableRequested = false;")
