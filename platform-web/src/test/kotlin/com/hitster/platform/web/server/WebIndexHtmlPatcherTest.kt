...
class WebIndexHtmlPatcherTest {
    ...
    fun patchInjectsMobileViewportTouchHandlingCanvasSizingAndWakeLockSupport() {
        ...
        assertContains(patchedHtml, "document.addEventListener(\"touchend\", enableNoSleep, false);")
        assertContains(patchedHtml, "document.addEventListener(\"pointerup\", enableNoSleep, false);")
        assertContains(patchedHtml, "detachWakeHandlers();")
        assertContains(patchedHtml, "attachWakeHandlers();")
        ...
        assertContains(patchedHtml, "\"handlers \" + (wakeHandlersAttached ? \"armed\" : \"off\")")
        assertContains(patchedHtml, "\"pending \" + (wakeEnableInFlight ? \"yes\" : \"no\")")
        ...
        assertContains(patchedHtml, "enableNoSleep(event);")
