...
class WebIndexHtmlPatcherTest {
    ...
    fun patchInjectsMobileViewportTouchHandlingCanvasSizingWakeLockAndFullscreenSupport() {
        ...
        assertContains(patchedHtml, """<svg id="hitster-fullscreen-icon"""")
        ...
        assertContains(patchedHtml, "fullscreenButton.setAttribute(\"title\", fullscreenActive ? \"Exit fullscreen\" : \"Enter fullscreen\");")
