...
- liquid-glass-style UI chrome that favors soft rounded translucent surfaces over rigid framed boxes, using real shader-backed treatment where practical rather than only flat shape fills
